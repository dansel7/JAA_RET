...
<div id="cuerpo">
    ...
    <table style="margin:auto;">
    	<tr>
			...
			<input type="text" name="iniciales"  id="iniciales" class="textbox_white" autofocus="autofocus" />
			<input type="submit" class="boton_general" value="Buscar usuario" name="buscar" />
			</form>
	</div>
			<div class="gris12">Nombre de usuario </div></td>
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td><div class="boton2" style="margin-right:74px;margin-bottom:25px"><div class="boton2_2" OnClick="location.href='nuevo_usuario.php'">NUEVO &nbsp;&nbsp; USUARIO</div></div><div class="gris12">Iniciar un nuevo registro de usuario</div></td>
        </tr>
    </table>
   	</div>
    <div id="foot_body">
